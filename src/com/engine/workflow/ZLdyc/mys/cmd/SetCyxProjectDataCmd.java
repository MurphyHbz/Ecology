...
public class SetCyxProjectDataCmd extends AbstractCommonCommand<Map<String, Object>>  {

    private BaseBean bs = new BaseBean();
    Map<String, Object> resultMap = new HashMap<>(2);
    public SetCyxProjectDataCmd(Map<String, Object> map) {
        this.params = map;
    }
               ...
               Boolean flag=true;
                for (int i = 0; i < list.size(); i++) {
                    ...
                    for (Map.Entry<String, Object> entry : hashMap.entrySet()) {
                        ...
                        //排除明细数据
                        if(entry.getKey().equals("projectEstateList")){
                            detailList =JSONObject.parseArray(entry.getValue().toString()) ;
                        }else {
