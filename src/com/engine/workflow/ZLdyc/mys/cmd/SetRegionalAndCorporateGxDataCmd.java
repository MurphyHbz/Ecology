...
public class SetRegionalAndCorporateGxDataCmd extends AbstractCommonCommand<Map<String, Object>>  {

    private BaseBean bs = new BaseBean();
    Map<String, Object> resultMap = new HashMap<>(2);
    public SetRegionalAndCorporateGxDataCmd(Map<String, Object> map) {
        this.params = map;
    }
